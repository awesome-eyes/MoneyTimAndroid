...
public class ExpenseListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tblHeader.setBackgroundColor(Color.GRAY);

        TextView tvCol = new TextView(this);
        tvCol.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20);
...
//                        mAdapter.add(item.toString());
                        ...
                        TextView tvCol = new TextView(self);
                        tvCol.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 18);
                        tvCol.setTypeface(Typeface.create("amatic-sc", Typeface.BOLD));
                        tvCol.setText(item.getCategory().toString());
                        tblRow.addView(tvCol);
                        tvCol = new TextView(self);
                        tvCol.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
                        ...
                        tblRow.addView(tvCol);
                        tvCol = new TextView(self);
                        tvCol.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
